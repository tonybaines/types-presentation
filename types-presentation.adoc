...
* That expressiveness is a large part of what I enjoy about developing in statically typed languages; as developers
...
we can make it more valuable to us in our day to day work, and to teh systems we build.
--
